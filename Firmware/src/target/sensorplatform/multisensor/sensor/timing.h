...
namespace Timing
{
    extern const SensorType timingSensorType;

    class TimingSensor : public Sensor
    {
    public:
        ...
        constexpr TimingSensor(uint8_t id) : Sensor(&timingSensorType, id, capture) {}
    };

    extern TimingSensor timingSensor;
}
