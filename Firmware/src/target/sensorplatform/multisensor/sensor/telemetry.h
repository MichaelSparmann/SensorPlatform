...
namespace Telemetry
{
    extern const SensorType telemetrySensorType;

    class TelemetrySensor : public Sensor
    {
    public:
        ...
        constexpr TelemetrySensor(uint8_t id) : Sensor(&telemetrySensorType, id, capture) {}
    };

    extern TelemetrySensor telemetrySensor;
}
