...
namespace USB
{
    // Various definitions and descriptor structs follow. See USB standards for details.
    ...
    // Abstract base class for USB Endpoint implementation
    ...
    // Abstract base class for USB Alternate Setting implementation
    ...
    // Abstract base class for USB Interface implementation
    ...
    // Abstract USB stack base class (extended by hardware driver)
    class __attribute__((packed,aligned(4))) USB
    {
    private:
        // Hardware driver functions only called from within the USB stack's core
    ...
    public:
        ...
        void start();
        void stop();
        // Interface for USB interface/endpoint/... implementations
        ...
        // Interface for USB interface/endpoint/... implementations (provided by hardware driver)
        ...
        // Default callbacks for standard control pipe transfers
        ...
        // Hooks for USB stack extensions
        ...
        const void* ep0TxPtr;
        uint16_t ep0TxLen;
        // USB stack configuration (written by constructor)
